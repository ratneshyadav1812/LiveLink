...
export const Loader1 = () => {
    return (
        <StyledWrapper className='w-full h-full justify-center flex items-center '>
...
export const Loader2 = () => {
    return (
        <StyledWrapper2 className='w-full h-full justify-center flex items-center '>
...
export const Loader3 = () => {
    return <>
        <Spline scene="https://prod.spline.design/ACInsTMBtw-8-DNl/scene.splinecode" />    </>
}